...
POISON_STATUS_DESCRIPTION = StatusDescription("Poisoned", GraphicChar(None, colors.GREEN, icon.POTION), "Poisoned, while poisoned you will take poison damage, the poison will wear off after a while.")
