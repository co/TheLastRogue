...
def new_training_dummy(gamestate):
    ...
    monster.set_child(DataPoint(DataTypes.EVASION, 12))
...
def new_ratman(gamestate):
    ...
    ratman.set_child(DataPoint(DataTypes.EVASION, 12))
    ratman.set_child(DataPoint(DataTypes.ACCURACY, 13))
...
def new_ratman_mystic(gamestate):
    ...
    ratman.set_child(DataPoint(DataTypes.EVASION, 12))
    ratman.set_child(DataPoint(DataTypes.ACCURACY, 11))
...
def new_worm(gamestate):
    ...
    worm.set_child(DataPoint(DataTypes.EVASION, 8))
    worm.set_child(DataPoint(DataTypes.ACCURACY, 10))
...
def new_skeleton(gamestate):
    ...
    skeleton.set_child(DataPoint(DataTypes.EVASION, 14))
    skeleton.set_child(DataPoint(DataTypes.ACCURACY, 13))
...
def new_spider(gamestate):
    ...
    spider.set_child(DataPoint(DataTypes.EVASION, 10))
...
def new_dust_demon(gamestate):
    ...
    demon.set_child(DataPoint(DataTypes.EVASION, 10))
    demon.set_child(DataPoint(DataTypes.ACCURACY, 25))
...
def new_armored_beetle(gamestate):
    ...
    beetle.set_child(DataPoint(DataTypes.EVASION, 4))
    beetle.set_child(DataPoint(DataTypes.ACCURACY, 16))
...
def new_salamander(gamestate):
    ...
    salamander.set_child(DataPoint(DataTypes.ACCURACY, 15))
...
def new_cyclops(game_state):
    ...
    cyclops.set_child(DataPoint(DataTypes.EVASION, 6))
    cyclops.set_child(DataPoint(DataTypes.ACCURACY, 11))
...
def new_ghost(gamestate):
    ...
    ghost.set_child(DataPoint(DataTypes.EVASION, 18))
    ghost.set_child(DataPoint(DataTypes.ACCURACY, 14))
...
def new_pixie(gamestate):
    ...
    pixie.set_child(DataPoint(DataTypes.EVASION, 18))
    pixie.set_child(DataPoint(DataTypes.ACCURACY, 14))
...
def new_slime(game_state):
    ...
    slime.set_child(DataPoint(DataTypes.ACCURACY, 15))
...
def new_giant_amoeba(game_state):
    ...
    amoeba.set_child(DataPoint(DataTypes.ACCURACY, 15))
