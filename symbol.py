ROW_LENGTH = 16
CUSTOM_PART = 16 * ROW_LENGTH

DUNGEON_WALLS_ROW = CUSTOM_PART
CAVE_WALLS_ROW = CUSTOM_PART + ROW_LENGTH * 1
DUNGEON_FEATURE_ROW = CUSTOM_PART + ROW_LENGTH * 2
EQUIPMENT_ITEMS_ROW = CUSTOM_PART + ROW_LENGTH * 3
USABLE_ITEMS_ROW = CUSTOM_PART + ROW_LENGTH * 4
DUNGEON_ENTITIES_ROW = CUSTOM_PART + ROW_LENGTH * 5
TOMB_ENTITIES_ROW = CUSTOM_PART + ROW_LENGTH * 6
